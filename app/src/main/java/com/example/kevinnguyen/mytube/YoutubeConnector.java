package com.example.kevinnguyen.mytube;
...
public class YoutubeConnector {
    ...
    public List<VideoModel> search(String keywords){
        query.setQ(keywords);
        try{
            SearchListResponse response = query.execute();
            List<SearchResult> results = response.getItems();

            List<VideoModel> items = new ArrayList<VideoModel>();
    ...
    public List<VideoModel> getFavoriteVideo(List<String> favoriteVideoIds){
...
//    private <T extends com.google.api.services.youtube.model> List<VideoModel> generateVideoItemList(List<T> list) {
//        List<VideoModel> items = new ArrayList<VideoModel>();
//        for ( T element : list ){
//            VideoModel item = new VideoModel();
