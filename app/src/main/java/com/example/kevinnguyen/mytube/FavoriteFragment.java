...
//        Log.d(TAG, "Favorite list contents: " + SearchFragment.favoriteVideoIds);
    ...
    protected void updateVideosFound(){
        ...
        ArrayAdapter<VideoModel> adapter = new ArrayAdapter<VideoModel>(getActivity(), R.layout.favorite_item, searchResults) {
                ...
                checkBox.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(checked) {
                            ...
                            for(VideoModel item: SearchFragment.searchResults) {
